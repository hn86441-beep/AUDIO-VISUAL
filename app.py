...
SAMPLE_DATA = [
    ...
    {
        "رقم المشهد": 6,
        "الحوار بالعربية": "أعوذ بالله من الشيطان الرجيم، هذا البيت فيه شيء يا جماعة.",
        "الترجمة الصينية": "愿真主保护我们免受恶魔侵害，这房子里有邪祟。",
        "استراتيجية الترجمة": "التوسيع (Expansion/Explicitation)",
        "نوع التحدي": "تحديات دينية/عقائدية (مفاهيم إسلامية-صينية)",
        "ملاحظات": "توسيع الصيغة الدينية المختصرة (الاستعاذة) بشرح ضمني ليدرك المشاهد الصيني وظيفتها الوقائية.",
    },
    {
        "رقم المشهد": 7,
        "الحوار بالعربية": "خلّيها بينا وبينك يا رب، لا تفضحنا قدام الناس.",
        "الترجمة الصينية": "主啊，请为我们保守秘密，不要让我们在人前丢脸。",
        "استراتيجية الترجمة": "الترجمة الحرفية (Literal Translation)",
        "نوع التحدي": "تحديات ثقافية (عادات، تعابير اصطلاحية)",
        "ملاحظات": "حافظ المترجم على البنية الدعائية الحرفية رغم كونها غير مألوفة في التعبير الديني الصيني الشعبي.",
    },
    {
        "رقم المشهد": 8,
        "الحوار بالعربية": "الجني يتكلم بصوت غريب: أنا ساكن في جسدك منذ سنين، لن أخرج!",
        "الترجمة الصينية": "我已经附身在你体内多年，我不会离开的！",
        "استراتيجية الترجمة": "التعويض (Compensation)",
        "نوع التحدي": "تحديات صوتية (تزامن الشفاه/الإيقاع)",
        "ملاحظات": "تعويض عن نبرة الصوت المرعبة في الأصل عبر اختيار مفردات صينية أكثر حدة إيقاعيًا لتعويض ما فُقد صوتيًا.",
    },
    {
        "رقم المشهد": 9,
        "الحوار بالعربية": "لازم نروح عند الشيخ يقرأ عليها، الحالة مو طبيعية.",
        "الترجمة الصينية": "我们得去找法师给她诵经驱邪，情况不正常。",
        "استراتيجية الترجمة": "التكييف الثقافي (Cultural Adaptation)",
        "نوع التحدي": "تحديات دينية/عقائدية (مفاهيم إسلامية-صينية)",
        "ملاحظات": "استبدال 'الشيخ' بمقابل ثقافي صيني (法师 fǎshī) أقرب لمخيلة الجمهور المستهدف رغم اختلاف الخلفية الدينية.",
    },
    {
        "رقم المشهد": 10,
        "الحوار بالعربية": "لا حول ولا قوة إلا بالله، شو هالمنظر المخيف!",
        "الترجمة الصينية": "太可怕了！",
        "استراتيجية الترجمة": "الحذف (Omission / Deletion)",
        "نوع التحدي": "قيود تقنية (زمن العرض/عدد الأحرف)",
        "ملاحظات": "حذف الصيغة الدينية بالكامل والاكتفاء بنقل الانفعال العاطفي فقط بسبب ضيق زمن السترجة الحاد.",
    },
    {
        "رقم المشهد": 11,
        "الحوار بالعربية": "بنت الحلال ما تطلع من البيت بعد المغرب، هذا وقت خطير.",
        "الترجمة الصينية": "好人家的姑娘晚祷后不出门，这个时段很危险。",
        "استراتيجية الترجمة": "المعادلة الوظيفية (Functional Equivalence)",
        "نوع التحدي": "تحديات لغوية (تركيبية/نحوية)",
        "ملاحظات": "'بنت الحلال' تعبير ثقافي معقد نُقل عبر مكافئ وظيفي عام يحافظ على القيمة الأخلاقية الضمنية.",
    },
    {
        "رقم المشهد": 12,
        "الحوار بالعربية": "قرأ آية الكرسي وبسملة، وطلب منها ألا تخاف بعد اليوم.",
        "الترجمة الصينية": "他念了护身经文，告诉她从今以后不要再害怕。",
        "استراتيجية الترجمة": "التعميم (Generalization)",
        "نوع التحدي": "تحديات دينية/عقائدية (مفاهيم إسلامية-صينية)",
        "ملاحظات": "تعميم اسمي 'آية الكرسي' و'البسملة' المحدَّدين دينيًا إلى مفهوم عام 'تعويذة حامية' يفهمه غير المسلم.",
    },
]
...
# ----------------------------------------------------------------------------
    ...
    with st.container():
        st.markdown(
            '<div class="main-card rtl-text"><h3>🧠 المصنِّف التلقائي — ألصق المشهد وسأحلله لك</h3>'
            '<p>لا تختر التصنيف بنفسك. الصق الحوار العربي وترجمته الصينية فقط، '
            'واضغط "حلّل هذا المشهد"، وسأقترح لك الاستراتيجية ونوع التحدي مع تفسير علمي، '
            'ثم يمكنك إضافته للجدول بضغطة واحدة.</p></div>',
            unsafe_allow_html=True,
        )
